...
def get_loader(df_train, df_val) :
    train_dataset = UJIIndoorLocDataset(df_train, train=True)
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)

    val_dataset = UJIIndoorLocDataset(df_val, train=False)
...
def evaluate(best_model, val_data) :
    val_dataset = UJIIndoorLocDataset(val_data, train=False)
